...
"how-to-automate-tasks-with-pabbly-connect.md": {
	id: "how-to-automate-tasks-with-pabbly-connect.md";
  slug: "how-to-automate-tasks-with-pabbly-connect";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"is-n8n-cheaper-than-zapier.md": {
	id: "is-n8n-cheaper-than-zapier.md";
  slug: "is-n8n-cheaper-than-zapier";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"zapier-alternatives-for-hr-professionals.md": {
	id: "zapier-alternatives-for-hr-professionals.md";
  slug: "zapier-alternatives-for-hr-professionals";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
