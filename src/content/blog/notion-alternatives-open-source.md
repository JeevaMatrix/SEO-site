...
Pro tip: when evaluating open-source alternatives, consider the community and support available. TiddlyWiki, for example, has a large and active community of users and developers who contribute to the app and provide support. You can also [Try Notion free](https://notion.so/affiliates/YOURCODE) to see how it compares to these alternatives.
